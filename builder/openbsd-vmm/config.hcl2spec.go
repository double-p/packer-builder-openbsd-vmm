...
type FlatConfig struct {
	...
	VMTemplate                *string           `mapstructure:"vm_template" required:"true" cty:"vm_template" hcl:"vm_template"`
	BootDevice                *string           `mapstructure:"boot_device" cty:"boot_device" hcl:"boot_device"`
	Boot                      *string           `mapstructure:"boot" cty:"boot" hcl:"boot"`
	CdRom                     *string           `mapstructure:"cdrom" cty:"cdrom" hcl:"cdrom"`
	DiskFormat                *string           `mapstructure:"disk_format" cty:"disk_format" hcl:"disk_format"`
	DiskBase                  *string           `mapstructure:"disk_base" cty:"disk_base" hcl:"disk_base"`
	DiskSize                  *string           `mapstructure:"disk_size" cty:"disk_size" hcl:"disk_size"`
	MemorySize                *string           `mapstructure:"memory" cty:"memory" hcl:"memory"`
	LogDir                    *string           `mapstructure:"log_directory" cty:"log_directory" hcl:"log_directory"`
	OutDir                    *string           `mapstructure:"output_directory" cty:"output_directory" hcl:"output_directory"`
	UserData                  *string           `mapstructure:"user_data" cty:"user_data" hcl:"user_data"`
	GenFilesExtension         *string           `mapstructure:"gen_files_extension" cty:"gen_files_extension" hcl:"gen_files_extension"`
	GenFilesPattern           *string           `mapstructure:"gen_files_pattern" cty:"gen_files_pattern" hcl:"gen_files_pattern"`
}
